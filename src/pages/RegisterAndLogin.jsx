...
function RegisterAndLogin() {
  ...
  const handleOnClick = async () => {
    ...
    window.location.href = "http://timeyouback.up.railway.app/auth/google"; // Reemplaza esta URL con la ruta adecuada de tu servidor para la autenticación de Google
  };
