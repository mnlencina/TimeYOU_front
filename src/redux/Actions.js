...
export const getBrands = () => {
  const endpoint = `https://timeyouback.up.railway.app/brands`;
  return async function (dispatch) {
    try {
      let { data } = await axios(endpoint);
           dispatch({
...
export const getColor = () => {
  const endpoint = `https://timeyouback.up.railway.app/colors`;
  return async function (dispatch) {
    try {
      let { data } = await axios(endpoint);
      dispatch({
...
export const getStraps = () => {
  const endpoint = `https://timeyouback.up.railway.app/straps`;
  return async function (dispatch) {
    try {
      let { data } = await axios(endpoint);
        dispatch({
...
export const getStyles= () => {
  const endpoint = `https://timeyouback.up.railway.app/styles`;
  return async function (dispatch) {
    try {
      let { data } = await axios(endpoint);
       dispatch({
...
export const getFunctions= () => {
  const endpoint = `https://timeyouback.up.railway.app/functions`;
  return async function (dispatch) {
    try {
      let { data } = await axios(endpoint);
       dispatch({
